//The exit command will cause the shell to terminate its infinite loop and exit.
...
#define MAX_COMMAND_LENGTH (70) //Each command can have a maximum of 70 characters
#define MAX_NUM_ARGS (5) //Each command can have a maximum of 5 arguments
...
//This function will terminate all background processes by sending them a signal via the kill system call.
